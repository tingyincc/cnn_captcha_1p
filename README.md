...
Test Accuracy：100% on 90 test images. (Not online testing yet)
...
### Preprocessing
1. Now we observe the image carefully:
...
3. We use `cv2.findContours` for each image. If the contour fits our criteria, where number of contour == 1, area (w*h) between 150-600, w<30, h<30, we will record its x,y,w,h, and color pixel percentage in a rectangle list.![enter image description here](https://upload.cc/i1/2020/06/12/vGlgdN.jpg)

4. Then we turn all images to a binary image![enter image description here](https://upload.cc/i1/2020/06/12/OdCVoy.jpg)
...
7. Now we have 4 correct rectangles! We resize them to the same size and save to each folders.![enter image description here](https://upload.cc/i1/2020/06/12/Arp7VK.jpg) 
